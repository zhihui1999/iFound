...
import com.gizwits.opensource.appkit.DiyClass.FoundActivity;
...
public class GosMainActivity extends GosDeviceModuleBaseActivity {
	...
	private GosDeviceListActivity center;
	...
	private void initHandler() {
		...
		activity = (FoundActivity) manager.getActivity("A");
		center = (GosDeviceListActivity) manager.getActivity("B");
	...
	private void initPagerViewer() {
		...
		Intent intent2 = new Intent(context, GosDeviceListActivity.class);
		...
		setActionBar(false, false, "iFound定位");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_addDevice:
			...
			case R.id.action_setting:
				...
				switch (dingweitype) {
					case 1: {
						Toast.makeText(context, "低精度模式，低耗电", Toast.LENGTH_SHORT).show();
						break;
					}
					case 2: {
						Toast.makeText(context, "中精度模式，一般耗电", Toast.LENGTH_SHORT).show();
						break;
					}
					case 3: {
						//高精度模式，高耗电
						Toast.makeText(context, "高精度模式，高耗电", Toast.LENGTH_SHORT).show();
						break;
					}
				}
				break;
			...
			case R.id.action_type:
				messageCenterActivity.updateMap();
				break;
			//设置定位范围，超过则报警
				...
				new AlertDialog.Builder(this).setTitle("请输入定位范围")
						...
						.setPositiveButton("确定", new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialogInterface, int i) {
								...
								messageCenterActivity.diyDistance=Integer.parseInt(et.getText().toString());
							}
			...
			case R.id.action_baojing:
				if (baojinglinshi==1) {
					baojinglinshi=0;
					messageCenterActivity.baojing=false;
					Toast.makeText(context, "报警关闭，超出范围不报警", Toast.LENGTH_SHORT).show();
				}else {
					baojinglinshi=1;
					messageCenterActivity.baojing=true;
					Toast.makeText(context, "报警开启，超出范围报警", Toast.LENGTH_SHORT).show();
				}
				break;
		}
